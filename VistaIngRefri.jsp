<%-- 
    Document   : VistaIngRefri
    Created on : 12/02/2019, 11:23:45 AM
...
<html>
    <head>
        ...
        <title>INGRESO REFRIGERIO</title>
    </head>
    <br>
    <form> 
    <img src="img/richard.jpg" style="padding-left: 990px" />   
        ...
        <body >
          <div class="container buscar">            
            ...
            <div style="padding-left: 800px">                  
                <input  class="form-control" type="text" name="txtBuscar4" placeholder="INGRESE FECHA"/>  
        ...
        rs = smt.executeQuery("SELECT * FROM TB_IngresoRefri ");
        
        %>           
        </div>       
        <br>
        <div class="container">
            <h1 style="font-size: 30px">Lista de inicio de Refrigerio</h1>
            <br>
            <%
        String dato = request.getParameter("txtBuscar4");
            ...
            if(dato != null){
                smt = con.createStatement();
                rs = smt.executeQuery("select * from TB_IngresoRefri where DIa like  '%"+dato+"%'");
            }
         ...
         <table  class="table table-bordered"  id="tablaDatos">
                    <tr>
                                ...
                                <th class="text-center">Comienzo de Refrigerio</th>  
                ...
                <tr class="text-center">                
                    ...
                    <td class="text-center"><%= rs.getString("Hora_Ingreso_Refri")%></td> 
