    ...
    <body>
        ...
        <div class="container buscar">            
            <a href="Acceso.html"> <button type="button" class="btn btn-success btn-lg" data-toggle="modal" data-target="#myModal">Regresar</button></a>
             <a href="VistaIngresos.jsp"> <button type="button" class="btn btn-success btn-lg" data-toggle="modal" data-target="#myModal">Ver Ingresos</button></a>
        ...
        <div class="container">
         ...
         <table  class="table table-bordered"  id="tablaDatos">
               ...
               .
                ...
                .
                <input type="hidden" name="txthora"  class="form-control" value="<%= rs.getString("Hora_entrada_emp")%>"/><br>    
                  .
                <input type="hidden" name="txtemp"  class="form-control" value="<%= rs.getString("Empresa")%>"/><br>    
                   ...
                   <!-- <td class="text-center"><%= rs.getString("Celular_trab")%></td>-->
                    ...
                    <td class="text-center"> <input  class="form-control" type="text" name="txttemp" placeholder="TEMPERATURA °C" style="width: 200px"/></td>
...
<%
        ...
        String temp = request.getParameter("txttemp");
            if(nom != null){
                pstm=con.prepareStatement("insert into TB_ingreso (Dni_trab, Nombres, Apellidos,Hora_entrada,Empresa,Temperatura)values('"+dni+"','"+nom+"','"+ape+"','"+hora+"','"+emp+"','"+temp+"')");
               pstm.executeUpdate();
                response.sendRedirect("VistaIngresos.jsp");
