...
<html>
   ...
   <body style="margin-top: 30px">
       <form target=" black">
        ...
        rs = smt.executeQuery("select * from fa_cbfact where ccod_cia = 'RCR' and ccond_pago = '01' and cstatus = 'A' and ddoc_fch ='"+dato+"'");
        ...
        ResultSet r;
        smt = con.createStatement();
        r = smt.executeQuery("select sum(nimp_t_mof) as Total from fa_cbfact where ccod_cia = 'RCR' and ccond_pago = '01' and cstatus = 'A' and ddoc_fch = '"+dato+"'");
        ...
        <form class="form">
                ...
                <div style="padding-left: 1000px">
                    ...
                    <th><b>Total de Liquidacion credito de dia:</b></th>
                        ...
                        <td><input style="font-size: 30px; width: 200px" class="form-control"  readonly="" name="txttotal" value="<%=r.getDouble("Total")%>"/></td>
                    </table>
                </div>
        </form>
        <%
