<%-- 
    Document   : VistaSalidas
    Created on : 11/02/2019, 02:25:03 PM
...
<html>
    ...
    <img src="img/richard.jpg" style="padding-left: 990px" />   
        ...
        <body >
          <div class="container buscar">            
            ...
            <div style="padding-left: 800px">                  
                <input  class="form-control" type="date"  name="txtBuscar4" placeholder="INGRESE FECHA" style="width: 200px"/>  
        ...
        rs = smt.executeQuery("SELECT * FROM TB_Salida ");
        ...
        String dato = request.getParameter("txtBuscar4");
            ...
            if(dato != null){
                smt = con.createStatement();
                rs = smt.executeQuery("select * from TB_Salida where Dia like  '%"+dato+"%'");
            }
         ...
         <table  class="table table-bordered"  id="tablaDatos">
                    <tr>
                                ...
                                <th class="text-center">Salida Marcada</th>  
                ...
                <tr class="text-center">                
                    ...
                    <td class="text-center"><%= rs.getString("Hora_Termino")%></td> 
