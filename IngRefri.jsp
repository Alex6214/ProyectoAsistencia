<%-- 
    Document   : IngRefri
    Created on : 12/02/2019, 11:20:58 AM
...
<%
        ...
        String ape = request.getParameter("txtape");
            ...
            if(nom != null){
                pstm=con.prepareStatement("insert into TB_ingresoRefri (Dni_trab, Nombres, Apellidos)values('"+dni+"','"+nom+"','"+ape+"')");
               pstm.executeUpdate();
                response.sendRedirect("VistaIngRefri.jsp");
